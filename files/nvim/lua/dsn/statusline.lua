...
local lsp_get_diag = function(severity)
  local count = #vim.diagnostic.get(0, { severity })
...
local comps = {
    ...
    diagnos = {
        ...
        warn = {
            ...
            provider = function()
                return '' ..  lsp_get_diag(vim.diagnostic.severity.WARNING)
            end,
            -- left_sep = ' ',
        ...
        info = {
            ...
            provider = function()
                return '' .. lsp_get_diag(vim.diagnostic.severity.INFORMATION)
            end,
            -- left_sep = ' ',
            enabled = function() return lsp.diagnostics_exist(vim.diagnostic.severity.INFORMATION) end,
            hl = {
                fg = colors.blue
            }
        },
